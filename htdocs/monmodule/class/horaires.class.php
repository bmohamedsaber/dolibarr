...
/**
 *  \file       dev/skeletons/horaires.class.php
 *  \ingroup    mymodule othermodule1 othermodule2
 *  \brief      This file is an example for a CRUD class file (Create/Read/Update/Delete)
 *				Initialy built by build_class_from_table on 2015-04-15 19:22
 */
 ...
 */
class Horaires extends CommonObject
{
	var $db;							//!< To store db handler
	var $error;							//!< To return error code (or message)
	var $errors=array();				//!< To return several error codes (or messages)
	var $element='horaires';			//!< Id that identify managed objects
	var $table_element='horaires';		//!< Name of table without prefix where object is stored
    ...
    function create($user, $notrigger=0)
    {
		...
		$sql.= " ".(! isset($this->pcg_subtype)?'NULL':"'".$this->db->escape($this->pcg_subtype)."'").",";
		$sql.= " ".(! isset($this->account_number)?'NULL':"'".$this->db->escape($this->account_number)."'").",";
    ...
    function fetch($id,$ref='')
    {
		...
		$sql.= " t.datec,";
		$sql.= " t.tms,";
		$sql.= " t.fk_pcg_version,";
		$sql.= " t.pcg_type,";
		$sql.= " t.pcg_subtype,";
		$sql.= " t.account_number,";
		$sql.= " t.account_parent,";
		$sql.= " t.label,";
    ...
    function update($user, $notrigger=0)
    {
		...
		$sql.= " pcg_subtype=".(isset($this->pcg_subtype)?"'".$this->db->escape($this->pcg_subtype)."'":"null").",";
		$sql.= " account_number=".(isset($this->account_number)?"'".$this->db->escape($this->account_number)."'":"null").",";
