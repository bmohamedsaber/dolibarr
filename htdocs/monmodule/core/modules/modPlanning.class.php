 ...
 *  \file       htdocs/mymodule/core/modules/modPlanning.class.php
 *  \ingroup    mymodule
...
class modPlanning extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->description = "Gestion du temps";
		...
		$this->config_page_url = array("horaires_page.php@monmodule");
        ...
        // Dictionaries
	    if (! isset($conf->monmodule->enabled))
        {
        ...
        */
		...
		$this->menu[$r]=array(	'fk_menu'=>0,			                // Put 0 if this is a top menu
									...
									'mainmenu'=>'monmodule',
									'leftmenu'=>'monmodule',
									'url'=>'/monmodule/index.php',
									'langs'=>'mylangfile@monmodule',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>100,
