...
--ALTER TABLE llx_horaires_param ADD UNIQUE INDEX uk_horaires_param (rowid);
...
--ALTER TABLE llx_horaires_param ADD CONSTRAINT fk_horaires_param_add_name FOREIGN KEY (fk_horaires_param_add)    REFERENCES llx_horaires_param (rowid);
